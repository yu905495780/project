...
Zzx.prototype ={
	init:function(){
		...
		this.testJson = {
						list:[
						        {src:"1",title:"灿烂一笑",song:"ydc",singer:"一朵"},
						        {src:"2",title:"真的好想你",song:"zbqz",singer:"周冰倩"},
								{src:"3",title:"东方微笑",song:"wxyd",singer:"王小艳"},
						        {src:"4",title:"这一分钟",song:"bmz",singer:"白描"},
						        {src:"5",title:"天上的月你的脸",song:"cbt",singer:"程璧"},
						        {src:"6",title:"这里怎么有这么多奇怪的人",song:"lwz",singer:"龙宽"},
                                {src:"7",title:"我不要",song:"sjyw",singer:"宋靖宇"},
						        {src:"8",title:"天使在夜里哭",song:"zzht",singer:"周子寒"},
						        {src:"9",title:"邻家娃娃",song:"wxl",singer:"王旭"},
						        {src:"10",title:"青石巷",song:"yyzlq",singer:"音乐走廊"},
						        {src:"11",title:"幸福后乐园",song:"kwxx",singer:"邝文珣"},
						        {src:"12",title:"我不后悔",song:"xxw",singer:"谢新"},
						        {src:"13",title:"别让誓言成谎言",song:"yxqb",singer:"亚小七"},
						        {src:"14",title:"我以为我可以",song:"xbjw",singer:"薛炳进"},
						        {src:"15",title:"不要对我说再见",song:"yyzlb",singer:"音乐走廊"},
						        {src:"16",title:"月中天",song:"yxzy",singer:"殷馨梓"},
						        {src:"17",title:"爱走了，可惜",song:"lgwa",singer:"林国伟"},
								{src:"18",title:"习惯的爱",song:"zyxx",singer:"赵佑勋"},
						        {src:"19",title:"三生石上刻相思",song:"yyzls",singer:"音乐走廊"},
							]
						}
