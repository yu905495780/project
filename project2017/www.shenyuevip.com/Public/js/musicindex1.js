...
Zzx.prototype ={
	init:function(){
		...
		this.testJson = {
						list:[							
								{src:"灿烂一笑",title:"一朵",song:"ydc",singer:"一朵"},
						        {src:"真的好想你",title:"周冰倩",song:"zbqz",singer:"周冰倩"},
								{src:"东方微笑",title:"王小艳",song:"wxyd",singer:"王小艳"},
						        {src:"这一分钟",title:"白描",song:"bmz",singer:"白描"},
						        {src:"天上的月你的脸",title:"程璧",song:"cbt",singer:"程璧"},
						        {src:"这里怎么有这么多奇怪的人",title:"龙宽",song:"lwz",singer:"龙宽"},
                                {src:"我不要",title:"宋靖宇",song:"sjyw",singer:"宋靖宇"},
						        {src:"天使在夜里哭",title:"周子寒",song:"zzht",singer:"周子寒"},
						        {src:"邻家娃娃",title:"王旭",song:"wxl",singer:"王旭"},
						        {src:"青石巷",title:"音乐走廊",song:"yyzlq",singer:"音乐走廊"},
						        {src:"幸福后乐园",title:"邝文珣",song:"kwxx",singer:"邝文珣"},
						        {src:"我不后悔",title:"谢新",song:"xxw",singer:"谢新"},
						        {src:"别让誓言成谎言",title:"亚小七",song:"yxqb",singer:"亚小七"},
						        {src:"过期香水",title:"周渔",song:"zyg",singer:"周渔"},
						        {src:"我以为我可以",title:"薛炳进",song:"xbjw",singer:"薛炳进"},
						        {src:"不要对我说再见",title:"音乐走廊",song:"yyzlw",singer:"音乐走廊"},
						        {src:"月中天",title:"殷馨梓",song:"yxzy",singer:"殷馨梓"},
						        {src:"爱走了，可惜",title:"林国伟",song:"lgwa",singer:"林国伟"},
								{src:"习惯的爱",title:"赵佑勋",song:"zyxx",singer:"赵佑勋"},
						        {src:"三生石上刻相思",title:"音乐走廊",song:"yyzls",singer:"音乐走廊"},
							]
						}
	...
	loadDate:function(oList){			
		switch(this.type){  
			//根据不同的模块 定制不同的数据展示形式
			case 1:this.ulTarget.append('<li onclick="myControl.selectList(this,'+this.stack+')" style="width: 547px;float: left;">'
									  ...
									  + '<div class="mu-l" style="width: 300px;text-align:left">'+oList[this.stack].src+'</div>'
									  + '<div class="textBox dot" style="width: 100px;text-align:left">'+oList[this.stack].title+'</div>'
...
var Control = function(o){
	...
	this.path            = "/www.shenyuevip.com/Public/music/";  //歌曲路径（相对于html）
...
function ZzxMusic(){
	...
	//模块设置
	var setting = {
		newSong:{'target':'newSong','type':'1','firstCount':20,'Count':10}
	};
