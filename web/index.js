var requirejs, require, define; !
    function(global) {
        ...
        function mixin(e, t, r, i) {
            return t && eachProp(t,
                function(t, n) { ! r && hasProp(e, n) || (!i || "object" != typeof t || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[n] = t: (e[n] || (e[n] = {}), mixin(e[n], t, r, i)))
                }),
                e
        }
        function bind(e, t) {
        ...
        function newContext(e) {
            function t(e) {
                var t, r;
                for (t = 0; t < e.length; t++) if (r = e[t], "." === r) e.splice(t, 1),
                    t -= 1;
                else if (".." === r) {
            ...
            function r(e, r, i) {
                var n, o, a, s, u, c, d, p, f, l, h, m, g = r && r.split("/"),
                    v = w.map,
                    x = v && v["*"];
            ...
            function i(e) {
                isBrowser && each(scripts(),
                    function(t) {
                        if (t.getAttribute("data-requiremodule") === e && t.getAttribute("data-requirecontext") === q.contextName) return t.parentNode.removeChild(t),
                            !0
                    })
            }
            function n(e) {
            ...
            function a(e, t, i, n) {
                ...
                return e || (l = !1, e = "_@r" + (A += 1)),
                    ...
                    d = c[0],
                    e = c[1],
                d && (d = r(d, p, n), s = getOwn(j, d)),
                e && (d ? h = s && s.normalize ? s.normalize(e,
                    function(e) {
                        return r(e, p, n)
                    }) : e.indexOf("!") === -1 ? r(e, p, n) : e: (h = r(e, p, n), c = o(h), d = c[0], h = c[1], i = !0, a = q.nameToUrl(h))),
                    u = !d || s || i ? "": "_unnormalized" + (T += 1),
                {
                    prefix: d,
                    name: h,
                    parentMap: t,
            ...
            function s(e) {
                var t = e.id,
                    r = getOwn(S, t);
                return r || (r = S[t] = new q.Module(e)),
                    r
            }
            function u(e, t, r) {
                var i = e.id,
                    n = getOwn(S, i); ! hasProp(j, i) || n && !n.defineEmitComplete ? (n = s(e), n.error && "error" === t ? r(n.error) : n.on(t, r)) : "defined" === t && r(j[i])
            }
            function c(e, t) {
            ...
            function f(e, t, r) {
                ...
                e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps,
                    function(i, n) {
                        var o = i.id,
                            a = getOwn(S, o); ! a || e.depMatched[n] || r[o] || (getOwn(t, o) ? (e.defineDep(n, j[o]), e.check()) : f(a, t, r))
                    }), r[i] = !0)
            }
            function l() {
                ...
                if (!x) {
                    if (x = !0, eachProp(k,
                            function(e) {
                                var r = e.map,
                                    c = r.id;
                                if (e.enabled && (r.isDefine || s.push(e), !e.error)) if (!e.inited && o) n(c) ? (t = !0, u = !0) : (a.push(c), i(c));
            ...
            return E = {
                ...
                b.prototype = {
                    init: function(e, t, r, i) {
                        i = i || {},
                        this.inited || (this.factory = t, r ? this.on("error", r) : this.events.error && (r = bind(this,
                            function(e) {
                                this.emit("error", e)
                            ...
                            if (this.inited) {
                                if (this.error) this.emit("error", this.error);
                                    ...
                                    if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                        if (isFunction(n)) {
                                            try {
                                                exports = q.execCb(r, n, i, exports)
                                            } catch(t) {
                                                e = t
                                            }
                                            if (this.map.isDefine && void 0 === exports && (t = this.module, t ? exports = t.exports: this.usingExports && (exports = this.exports)), e) {
                                        ...
                                        if (this.exports = exports, this.map.isDefine && !this.ignore && (j[r] = exports, req.onResourceLoad)) {
                                            var o = [];
                                            each(this.depMaps,
                                                function(e) {
                                                    o.push(e.normalizedMap || e)
                                                }),
                                                req.onResourceLoad(q, this.map, o)
                                        }
                                        p(r),
                                            this.defined = !0
                                    }
                        ...
                        this.depMaps.push(i),
                            u(i, "defined", bind(this,
                                function(i) {
                                    ...
                                    return this.map.unnormalized ? (i.normalize && (l = i.normalize(l,
                                            function(e) {
                                                return r(e, h, !0)
                                            }) || ""), o = a(e.prefix + "!" + l, this.map.parentMap), u(o, "defined", bind(this,
                                        function(e) {
                                        ...
                                        })), d = getOwn(S, o.id), void(d && (this.depMaps.push(o), this.events.error && d.on("error", bind(this,
                                        function(e) {
                                            this.emit("error", e)
                                ...
                                function(e, t) {
                                    ...
                                    if ("string" == typeof e) {
                                        ...
                                        this.depCount += 1,
                                            ...
                                            this.errback ? u(e, "error", bind(this, this.errback)) : this.events.error && u(e, "error", bind(this,
                                                function(e) {
                                                    this.emit("error", e)
                                                }))
                                    }
                ...
                q = {
                    ...
                    makeRequire: function(t, n) {
                        function o(r, i, u) {
                            ...
                            return n.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0),
                                "string" == typeof r ? isFunction(i) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(E, r) ? E[r](S[t.id]) : req.get ? req.get(q, r, t, o) : (p = a(r, t, !1, !0), d = p.id, hasProp(j, d) ? j[d] : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "": ". Use require([])")))) : (v(), q.nextTick(function() {
                                    v(),
                                        f = s(a(null, t)),
                                        f.skipMap = n.skipMap,
                                        f.init(r, i, u, {
                            ...
                            mixin(o, {
                                ...
                                toUrl: function(e) {
                                    var i, n = e.lastIndexOf("."),
                                        o = e.split("/")[0],
                                        a = "." === o || ".." === o;
                                    return n !== -1 && (!a || n > 1) && (i = e.substring(n, e.length), e = e.substring(0, n)),
                                        q.nameToUrl(r(e, t && t.id, !0), i, !0)
                                },
                                defined: function(e) {
                    ...
                    completeLoad: function(e) {
                        ...
                        if (q.defQueueMap = {},
                                i = getOwn(S, e), !t && !hasProp(j, e) && i && !i.inited) {
                    ...
                    nameToUrl: function(e, t, r) {
                        ...
                        if (req.jsExtRegExp.test(e)) s = e + (t || "");
                            ...
                            s = n.join("/"),
                                s += t || (/^data\:|\?/.test(s) || r ? "": ".js"),
                                s = ("/" === s.charAt(0) || s.match(/^[\w\+\.\-]+:/) ? "": w.baseUrl) + s
                        }
                        return w.urlArgs ? s + ((s.indexOf("?") === -1 ? "?": "&") + w.urlArgs) : s
                    },
                    load: function(e, t) {
                        req.load(q, e, t)
                    },
                    execCb: function(e, t, r, exports) {
                        return t.apply(exports, r)
                    },
                    ...
                    onScriptError: function(e) {
                        ...
                        if (!n(t.id)) {
                            ...
                            return eachProp(S,
                                function(e, i) {
                                    0 !== i.indexOf("_@r") && each(e.depMaps,
                                        function(e) {
                                            return e.id === t.id && r.push(i),
                                                !0
                                        })
                                }),
        ...
        if ("undefined" == typeof define) {
            ...
            "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0),
                req = requirejs = function(e, t, r, i) {
                    ...
                    return isArray(e) || "string" == typeof e || (o = e, isArray(t) ? (e = t, t = r, r = i) : e = []),
            ...
            isBrowser && (head = s.head = document.getElementsByTagName("head")[0], baseElement = document.getElementsByTagName("base")[0], baseElement && (head = s.head = baseElement.parentNode)),
                ...
                req.load = function(e, t, r) {
                    var i, n = e && e.config || {};
                    if (isBrowser) return i = req.createNode(n, t, r),
                    n.onNodeCreated && n.onNodeCreated(i, n, t, r),
            ...
            isBrowser && !cfg.skipDataMain && eachReverse(scripts(),
                ...
                define = function(e, t, r) {
                    ...
                    !t && isFunction(r) && (t = [], r.length && (r.toString().replace(commentRegExp, "").replace(cjsRequireRegExp,
                        function(e, r) {
                            t.push(r)
